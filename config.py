...
class CollectorSettings(BaseSettings):
    ...
    serper_api_key: str = Field(default="", description="Serper Search API密钥")
    search_provider: str = Field(default="auto", description="搜索API提供商，auto/serper/bing")
    search_max_queries: int = Field(default=0, description="搜索采集单轮最多查询数，0表示全部")
    search_max_results_per_query: int = Field(default=10, description="搜索采集每个查询最大结果数")
    search_per_query_timeout: int = Field(default=30, description="搜索采集单个查询最大等待秒数")
